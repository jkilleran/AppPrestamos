                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        helperText: _minAmount != null && _maxAmount != null ? 'Entre ${_minAmount!.toStringAsFixed(0)} y ${_maxAmount!.toStringAsFixed(0)}' : null,
                      ),
                      validator: (v) {
                        final value = double.tryParse(v ?? '');
                        if (value == null || value <= 0) return 'Ingresa un monto válido';
                        if (_minAmount != null && value < _minAmount!) return 'Monto mínimo: ${_minAmount!.toStringAsFixed(0)}';
                        if (_maxAmount != null && value > _maxAmount!) return 'Monto máximo: ${_maxAmount!.toStringAsFixed(0)}';
                        return null;
                      },
                    ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Slider(
                            ...
                            divisions: (_maxMonths != null && _minMonths != null) ? (_maxMonths! - _minMonths! > 0 ? _maxMonths! - _minMonths! : 1) : 7,
                            label: '$_months meses',
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Slider(
                            ...
                            min: _minInterest ?? 5,
                            max: _maxInterest ?? 30,
                            divisions: ((_maxInterest ?? 30) - (_minInterest ?? 5)).round(),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Monto: [32m${_amountController.text.isEmpty ? '-' : _amountController.text}[0m'),
